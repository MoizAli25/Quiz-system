...
const question4 = await inquirer.prompt([
    {
        name: "four",
        message: 'What is the type of the variable value in the following code? let value: any = "Hello";',
        type: "list",
...
const question5 = await inquirer.prompt([
    {
        name: "five",
        message: "What is the output of the following TypeScript code? console.log(typeof 42);",
        type: "list",
        choices: ["string", "any", "number", "boolean"],
    },
]);
